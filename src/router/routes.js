...
const routes = [
    ...
    { 
        ...
        children: [
            ...
            { path: 'assessments', name: 'assessments', component: Assesments, meta: {type: 'assessments', displayName: 'Assessments', siteDescription: 'Measuring Proficiency: Gauging Learning Outcomes and Knowledge Mastery' } },
            ...
            { path: 'quizzes', name: 'quizes', component: Quizes, meta: {type: 'quizzes', displayName: 'Quizzes', siteDescription: 'Interactive quizzes to test your knowledge.' } },
            { path: 'homeworks', name: 'homeworks', component: Homeworks, meta: {type: 'homeworks', displayName: 'Homeworks', siteDescription: 'Engaging homework assignments to reinforce learning.' } },
            { path: 'tests', name: 'tests', component: Tests, meta: {type: 'tests', displayName: 'Tests', siteDescription: 'Comprehensive assessment tests to track your progress.' } },
            ...
            { path: 'projects', name: 'projects', component: Projects, meta: {type: 'projects', displayName: 'Projects', siteDescription: 'Engaging projects to apply and enhance your skills.' } },
            { path: 'activities', name: 'activities', component: Activities, meta: {type: 'activities', displayName: 'Activities', siteDescription: 'Interactive activities for engaging learning experiences.' } },
