            ...
            <form class="quiz-form">
                <ol>
                    ...
                    <li class="mb-[2rem]">
                        ...
                        <p>What was Alice looking forward to during her vacation?</p>
                        <p>a) Building sandcastles</p>
                        <p>b) Going to a museum</p>
                        <p>c) Visiting a theme park</p>
                    ...
                    <li class="mb-[2rem]">
                        ...
                        <p>What was rumored about the old house?</p>
                        <p>a) It was for sale.</p>
                        <p>b) It was newly renovated.</p>
                        <p>c) It was haunted.</p>
                    ...
                    <li class="mb-[2rem]">
                        ...
                        <p>a) I love to read books.</p>
                        <p>b) i love to read books.</p>
                        <p>c) I Love to read books.</p>
                    ...
                    <li class="">
                        ...
                        <p>What did John do to buy his new bicycle?</p>
                        <p>a) He borrowed money from a friend.</p>
                        <p>b) He earned money from a part-time job.</p>
                        <p>c) He saved his allowance.</p>
                        <p>d) He won a bike in a contest.</p>
                    </li>
