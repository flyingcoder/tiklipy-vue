            ...
            <div class="flex items-center justify-between xl:gap-x-2 items-cente">
                ...
                <div class="flex self-center ml-auto text-right">
                    <div class="flex mr-5" v-if="route.path != '/members'">
                        <select v-model="sortQuery" class="block text-sm text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-main-color focus:secondary-color dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
