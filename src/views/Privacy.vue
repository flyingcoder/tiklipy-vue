...
<template>
    <div class="container mx-auto p-3 md:py-8 text-black ">
        <div class="max-w-3xl mx-auto p-4 sm:p-10 md:p-24 bg-white rounded-xl shadow-md">
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">1. Information Collection: What Data Do We Gather?</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">4. Opting Out: Third-Party Communication</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">7. Data Retention: How Long Do We Keep Your Information?</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">8. Data Security: How Do We Safeguard Your Information?</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">9. Minors' Data: Information Collection from Minors</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">10. Privacy Rights: What Are Your Rights?</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">11. Do-Not-Track Controls: Managing Tracking Features</h4>
            <p>We currently don't respond to Do-Not-Track browser signals.</p>

            <h4 class="text-lg font-bold mt-8 mb-4">12. Philippines Residents' Rights: Specific Privacy Rights?</h4>
            ...
            <h4 class="text-lg font-bold mt-8 mb-4">13. Policy Updates: Evolution of This Policy</h4>
            <p>This policy is updated as required to comply with laws. We notify significant changes and encourage periodic review.</p>

            <h4 class="text-lg font-bold mt-8 mb-4">14. Contact Us: How to Reach Us</h4>
