<script setup>
    ...
    if (!route.params.category) {
        ...
        title.value = `How can ${sitename.siteName} help you effectively?`;
    } else {
...
<template>
    <section class="bg-secondary-color dark:bg-gray-900 ">
        <div class="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
           ...
           <p class="text-lg mt-5 font-light">Commonly Addressed Subjects: {{sitename.siteName}}'s Functionality, Billing Queries, and FAQs.</p>
        </div>
        ...
        <ul class=" justify-center text-sm font-medium text-center divide-gray-200 flex flex-wrap dark:divide-gray-700 dark:text-gray-400 px-4">
            <li class="w-[49%] max-w-fit " @click="setActiveView('initiation')">
                <a class="inline-block w-full p-4 text-white font-semibold cursor-pointer rounded-lg xl:!rounded-t-xl xl:!rounded-b-none  transition duration-200	 bg-secondary-color hover:text-white hover:bg-[#a1a7e3] focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" :class="[ {'!text-black !bg-white': isViewActive('initiation') || route.params.category === 'initiation'}, route.params.category ? 'hover:bg-transparent !cursor-default' : '' ]">{{sitename.siteName}} Initiation</a>
            </li>
            <li class="w-[49%] max-w-fit " @click="setActiveView('knowhow')">
                <a class="inline-block w-full p-4 text-white font-semibold cursor-pointer rounded-lg xl:!rounded-t-xl  xl:!rounded-b-none   transition duration-200	 bg-secondary-color hover:text-white hover:bg-[#a1a7e3] focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" :class="[ {'!text-black !bg-white': isViewActive('knowhow') || route.params.category === 'knowhow'}, route.params.category ? 'hover:bg-transparent !cursor-default' : '' ]">{{sitename.siteName}} Knowhow</a>
            </li>
            <li class="w-[49%] max-w-fit " @click="setActiveView('ethics')">
                <a class="inline-block w-full p-4 text-white font-semibold cursor-pointer rounded-lg xl:!rounded-t-xl  xl:!rounded-b-none   transition duration-200	 bg-secondary-color hover:text-white hover:bg-[#a1a7e3] focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" :class="[ {'!text-black !bg-white': isViewActive('ethics') || route.params.category === 'ethics'}, route.params.category ? 'hover:bg-transparent !cursor-default' : '' ]">{{sitename.siteName}} Ethics</a>
            </li>
            <li class="w-[49%] max-w-fit " @click="setActiveView('applications')">
                <a class="inline-block w-full p-4 text-white font-semibold cursor-pointer rounded-lg xl:!rounded-t-xl  xl:!rounded-b-none   transition duration-200	 bg-secondary-color hover:text-white hover:bg-[#a1a7e3] focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" :class="[ {'!text-black !bg-white': isViewActive('applications') || route.params.category === 'applications'}, route.params.category ? 'hover:bg-transparent !cursor-default' : '' ]">{{sitename.siteName}} Applications</a>
            </li>
            <li class="w-[49%] max-w-fit " @click="setActiveView('accountancy')">
                <a class="inline-block w-full p-4 text-white font-semibold cursor-pointer rounded-lg xl:!rounded-t-xl  xl:!rounded-b-none   transition duration-200	 bg-secondary-color hover:text-white hover:bg-[#a1a7e3] focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" :class="[ {'!text-black !bg-white': isViewActive('accountancy') || route.params.category === 'accountancy'}, route.params.category ? 'hover:bg-transparent !cursor-default' : '' ]">{{sitename.siteName}} Accountancy</a>
            </li>
