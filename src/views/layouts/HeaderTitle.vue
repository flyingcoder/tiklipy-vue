...
<template>
    <div class="mt-7 px-4 lg:container md:mx-auto">
        <div class="block justify-center font-semibold">
            <span class="text-main-color tracking-wider text-sm uppercase mt-0 mb-1 font-poppins font-bold leading-6">
                {{ route.meta.pageTitle ? route.meta.pageTitle : 'WELCOME BACK' }}
            </span>
            <div class="flex flex-wrap md:justify-between items-start ">
                <div class="md:w-[80%] ">
                    <h2 class="text-gray-800 text-2xl  lg:text-3xl mt-2 mb-3">
                        {{ route.meta.siteDescription }}
                    </h2>
                </div>
                <div v-if="$route.name !== 'account'" class="w-full md:w-max flex justify-end	md:mt-2">
