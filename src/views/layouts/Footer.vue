                        ...
                        <div class="basis-full lg:basis-2/12">
                                <div class="mb-6 md:mb-0">
                                    <a href="https://flowbite.com/" class="max-xs:justify-center flex items-center">
                                        <img src="/public/tiklipy-logo-indigo.png" height="48" width="250" class="mr-3" alt="Tiklipy Logo" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="flex max-md:flex-col-reverse justify-between">
                        ...
                        <div class="flex mt-4 space-x-5 max-md:justify-center sm:mt-0">
                            <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                <svg class="text-main-color hover:text-secondary-color w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                                    </svg>
                                <span class="sr-only">Facebook page</span>
                            </a>
                            <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                <svg class="text-main-color hover:text-secondary-color w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
