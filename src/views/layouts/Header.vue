        ...
        <nav class="border-gray-200 dark:bg-gray-900 max-w-screen-2xl mx-auto">
            <div class="flex flex-wrap items-center justify-between px-4 py-6 mx-auto max-lg:justify-end">
                <div class="flex items-center md:order-3 relative z-10">
                    ...
                    <router-link v-if="isLoggedIn" :to="{ name: 'dashboard' }" active-class="text-main-color dark:text-white" class="max-xs:hidden block px-3 py-2 text-lg font-medium text-gray-900 divide-gray-100 dark:hover:text-main-color md:border-0 md:p-0">
                        <i class="pb-1 mr-1 text-lg ti ti-atom"></i> Portal
                    </router-link>  
                    <a @click="handleSignOut" v-if="isLoggedIn" href="#" class="max-xs:hidden text-white bg-main-color ml-2 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                      Logout
                    </a>
                    <button data-collapse-toggle="mega-menu" type="button" class="inline-flex items-center justify-center w-10 h-10 p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mega-menu" aria-expanded="false">
                ...
                <a href="https://flowbite.com" class="flex item-start sm:items-center ">
                    <img src="/public/tiklipy-logo-indigo.png" class="h-12 ml-4 sm:mx-auto" alt="Tiklipy Logo" />
                </a>
                </div>
                
                <div id="mega-menu" class="relative z-10 items-center justify-between hidden w-full lg:flex md:w-auto md:order-1">
                    <ul class="flex flex-col mt-4 text-lg font-medium md:flex-row md:space-x-1 md:mt-0 ">
                        ...
                        <li>
                            <router-link to="/pricing" class="text-base block py-2 pl-3 pr-4 text-gray-900 dark:text-white dark:hover:text-main-color dark:hover:bg-gray-700 dark:border-gray-700"
                                        active-class="text-main-color dark:text-white">Pricing</router-link>
                        </li>
                        <li v-if="isLoggedIn">
                            <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown"
                                    class="text-base flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-900 bg-transparent border-b border-gray-100 md:w-auto dark:text-white dark:hover:text-main-color dark:hover:bg-gray-700 dark:border-gray-700"
                            >
                                Assesment
                        ...
                        <li>
                            <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown"
                                    class="text-base flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-900 bg-transparent md:w-auto focus:outline-none hover:border-transparent hover:text-main-color dark:text-white focus:border-transparent focus:ring-0"
                            >
                                About
                                <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 10 6">
