    ...
    <div class="flex items-center justify-center pt-20">
        <div class="max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 lg:w-2/5 sm:w-96">
            ...
            <div class="items-center justify-center w-full px-6 text-black">
                ...
                <button @click="signIn"  :disabled="!email || !password" :class="[(!email || !password) || isLoading ? 'cursor-not-allowed !bg-gray-500 hover:bg-gray-500' : 'bg-main-color hover:bg-secondary-color', hasError?'animate__hinge z-10':'']" class="w-full px-4 py-2 mt-2 font-bold text-white bg-main-color rounded hover:bg-secondary-color">
