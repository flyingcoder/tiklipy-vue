                    ...
                    <div class="bg-white dark:bg-slate-800 shadow  rounded-md w-full p-4 relative overflow-hidden bg-[url('/p-1.png')] bg-no-repeat bg-contain cursor-pointer">
                        <div class="flex justify-between xl:gap-x-2 items-cente">
                            ...
                            <div class="self-center ml-auto text-right">                            
                                <h3 class="my-1 text-2xl font-semibold text-main-color">Generate Test</h3>
                                <p class="p-0 mb-0 text-lg font-light text-gray-700 bg-transparent hover:border-transparent focus:outline-none">The Journey and Significance of Tests</p>
                            </div>
                        </div>
                    </div> <!--end inner-grid--> 
                </div>
