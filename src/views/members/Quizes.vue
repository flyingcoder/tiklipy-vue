<script setup>
    ...
    const lessonsCard = {
        ...
        // tag: 'featured',
        tag: 'assessment',
        promptExample: 'Explore diverse nature topics in this engaging quiz. Test your knowledge of ecosystems, creatures, and more. Start now!',
        ...
        icon:'ti-user',
        description: 'Put Your Knowledge to the Test: Engaging Quiz to Assess Your Understanding',
        inputs: {
            grade: {
                value: '',
    ...
    <!-- <div class="mt-7 px-3">
        <div class="flex flex-wrap max-lg:justify-center">
            <div class=" w-[30rem] bg-white rounded-lg sm:mr-5 mb-5 flex">
                <router-link :to="{ name: 'assessment', params: { type: 'quizzes', id: 1 } }" class="bg-[url('/p-1.png')] bg-no-repeat bg-contain items-center bg-white rounded-lg  md:flex-row md:max-w-xl hover:shadow-lg transition delay-75 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <div class="p-10 max-xs:!p-5">
            ...
            <div class=" w-[30rem] bg-white rounded-lg sm:mr-5 mb-5 flex">
                <router-link :to="{ name: 'assessment', params: { type: 'quizzes', id: 2 } }" class="bg-[url('/p-1.png')] bg-no-repeat bg-contain items-center bg-white rounded-lg  md:flex-row md:max-w-xl hover:shadow-lg transition delay-75 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <div class="p-10 max-xs:!p-5">
                        <div class="flex items-center w-56 mb-5">
                            <img class="w-16 -ml-2" src="/grade.png" alt="">
                            <div class="text-5xl ">5</div>
            ...
            <div class=" w-[30rem] bg-white rounded-lg sm:mr-5 mb-5 flex">
                <router-link :to="{ name: 'assessment', params: { type: 'quizzes', id: 3 } }" class="bg-[url('/p-1.png')] bg-no-repeat bg-contain items-center bg-white rounded-lg  md:flex-row md:max-w-xl hover:shadow-lg transition delay-75 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <div class="p-10 max-xs:!p-5">
                        <div class="flex items-center w-56 mb-5">
                            <img class="w-16 -ml-2" src="/grade.png" alt="">
                            <div class="text-5xl ">5</div>
