...
<template>
    <div class="fixed top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full flex items-center justify-center">
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <p class="px-6 text-center">Sign in with</p>
                <div class="px-6 pb-6">
    ...
    <div class="fixed inset-0 z-10 bg-gray-900 bg-opacity-50 dark:bg-opacity-80"></div>
</template>