...
<template>
    ...
    <div class="max-w-screen-2xl mx-auto mt-5 midlg:mt-32">
        <div class="mx-2 sm:mx-5 flex max-lg:flex-wrap justify-center justify-between justify-items-center">
            <router-link class="sm:mx-2 pb-5" :to="{name: 'blog', params: { slug: 'tiklipy-and-artificial-intelligence' }}">
                <the-card variant="image" class="h-full	 mb-5 cursor-pointer" img-src="https://flowbite.com/docs/images/blog/image-1.jpg" img-alt="Desk">
