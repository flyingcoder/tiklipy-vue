...
<template>
  <header>
                        <nav class="bg-white border-gray-200 dark:bg-gray-900">
                          <div class="flex flex-wrap items-center justify-between py-6 mx-16">
                          <div class="flex items-center md:order-3">
                            ...
                            <a data-modal-target="signup-modal" data-modal-toggle="signup-modal" class="cursor-pointer text-white bg-main-color focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 focus:outline-none dark:focus:ring-blue-800 hover:text-white">Sign up</a>
                          ...
                          <div id="mega-menu" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                                  ...
                                  <li>
                                          <a href="#" class="block py-2 pl-3 pr-4 border-b border-gray-100 text-main-color hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-main-color md:p-0 dark:text-blue-500 md:dark:hover:text-main-color dark:hover:bg-gray-700 dark:hover:text-main-color md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Features</a>
                                  </li>
                                  <li>
                                      <a href="/pricing" class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-main-color md:p-0 dark:text-white md:dark:hover:text-main-color dark:hover:bg-gray-700 dark:hover:text-main-color md:dark:hover:bg-transparent dark:border-gray-700">Pricing</a>
                                  </li>
                                  <li>
                                  <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" class="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-900 bg-transparent border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-main-color md:p-0 dark:text-white md:dark:hover:text-main-color dark:hover:bg-gray-700 dark:hover:text-main-color md:dark:hover:bg-transparent dark:border-gray-700">
