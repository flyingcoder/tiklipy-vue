...
<template>
    <div class="block py-8 my-10 text-black px-14">
        <div class="container mx-auto pb-40 pt-7">
            <div class="block">
                <div class="text-7xl text-center text-gray-800 font-semibold mb-8">
                    Forging an innovative route to reshape<br> the landscape of education.
                </div>
                <div class="text-gray-800 text-xl text-center font-base">
                    Our mission is to propel education towards enhancement. Thus, we are<br> reshaping conventions and envisioning a new paradigm for educators' work.
                </div>
            </div>
        </div>
        <div class="container mx-auto">
            <div class="text-4xl text-center text-gray-700 font-semibold mb-5">
            ...
            <div class="grid grid-cols-3 gap-6 mt-7">
                <div class="block">
                    <img src="/public/gift.webp" class="mx-auto rotate-12 mb-4" alt="Gift" width="200" height="200">
                ...
                <div class="block">
                    <img src="/public/teaching.webp" class="mx-auto -rotate-12 mb-4" alt="Gift" width="200" height="200">
                ...
                <div class="block">
                    <img src="/public/hero.webp" class="mx-auto -rotate-2 mb-4" alt="Gift" width="200" height="200">
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-2 gap-6 mt-7 pt-16">
                <div class="block">
                    <img src="/public/creator.jpg" class="mx-auto mb-4" alt="Gift" >
                </div>
                <div class="block px-20 py-4">
