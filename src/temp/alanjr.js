export default [
    {
        ...
        systemPrompt: 'You will be provided with statements, and your task is to convert them to standard English.',
    ...
    },
    {
        ...
        systemPrompt: 'You will be given content and a grade level. Summarize the provided content for a student based on their grade level.',
        title: 'Summarization',
        icon: 'ti-tools',
    ...
    },
    {
        ...
        systemPrompt: 'You will be provided with unstructured data, and your task is to parse it into CSV format.',
    ...
    },
    {
        ...
        systemPrompt: 'You will be provided with text, and your task is to translate it into emojis. Do not use any regular text. Do your best with emojis only.',
    ...
    },
    {
        ...
        systemPrompt: "You will be provided with a block of text, and your task is to extract a list of keywords from it.",
    ...
    },
    {
        ...
        systemPrompt: "You will be provided with block of text and the Data Fields, and your task is to create spreadsheet based on the text and the Data Fields",
    ...
    },
    {
        ...
        systemPrompt: "You will be provided with a block of text, a specified number of questions, and a designated grade level. Your task is to formulate the questions, and the number of questions as well as the complexity of the questions should align with the given grade level.",
    ...
    },
    {
        ...
        systemPrompt: "You will be given a sentence and two languages in json format. Your task is to translate the sentence from its detected language to the second specified language.",
        title: 'translation',
        icon:'ti-tools',
    ...
    },
    {
        ...
        systemPrompt: "You will be provided with meeting notes, and your task is to summarize the meeting as follows: -Overall summary of discussion -Action items (what needs to be done and who is doing it) -If applicable, a list of topics that need to be discussed more fully in the next meeting.",
